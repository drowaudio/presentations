...
public:
    ...
    void initialise (const String&) override
    {
        ...
        treeWindow = new MainWindow (getApplicationName(), new ValueTreesDemo (editTree));
        arrangeWindow = new MainWindow (getApplicationName(), new ArrangeView (editTree));
    }
    ...
    void shutdown() override
    {
        ...
        arrangeWindow = nullptr; // (deletes our window)
        treeWindow = nullptr;
    ...
    */
    ...
    {
    public:
        MainWindow (String name, Component* contentComp)
...
private:
    ValueTree editTree;
    ScopedPointer<MainWindow> treeWindow, arrangeWindow;
};
